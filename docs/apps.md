...
This document describes every binary installed by SigilVM, their role in the ecosystem, and all supported command-line operations.

SigilVM installs several tightly integrated applications. Each binary is intentionally small, explicit in purpose, and communicates through SigilVM’s IPC layer.
