...
* **Application Framework** — explicit, deterministic C++ foundations for building tools and interactive software.
* **Game Engine** — Vulkan-based rendering, ECS simulation, media and networking systems.
...
The project uses **CMake** for builds, **bash** wrappers for convenience, and **Arch Linux packages** for distribution. Other platforms are supported through configuration described in the documentation.
...
SigilVM uses a strict, explicit coding style and a deterministic C++ dialect.
Contributions should match the project’s resource-oriented design and comply with subsystem boundaries.

All guidelines live in:
...
| **docs/api.md**          | API overview, context architecture, coding rules.                        |
| **docs/contributing.md** | Style guide, PR rules, internal conventions.                             |
