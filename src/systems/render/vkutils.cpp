...
// TODO: Refactor to return extensions in a vector of strings, via out param
::sigil::yield vk_list_extensions() {
...
::sigil::yield vk_probe_devices(std::vector<platform::gpu_info_t> &out_devices) {
    out_devices.clear();
    using namespace ::sigil;
    VkResult result;
...
bool sigil::render::is_vk_ext_available(const std::vector<VkExtensionProperties> &properties, const char* extension) {
