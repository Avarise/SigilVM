#include "hat.h"
// We cannot use block_created = 0, it would modify copy
std::atomic_uint32_t sigil::hat_engine::blocks_created(0);
// namespace sigil {
...
//             sigil::ntt::add_static_mesh_component(id, sigil::asset_t());
...
//             printf("\nHat: spawned %lu rabbits in %lu.%lums\n", scene->entities.size(), dura_ms, dura_us);
//         }
