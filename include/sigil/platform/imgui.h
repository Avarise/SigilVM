...
#include "sigil/platform/window.h"
#include "sigil/render/context.h"
#include "sigil/common.h"
#include "sigil/render/vkutils.h"

namespace sigil::imgui {
    // Main gui and vulkan, etc.
    // Has high-level wrapper for ImGui + Vulkan ctx init
    yield enable_gui(
    ...
    yield end_frame();
    yield draw_frame();
    bool should_draw(::sigil::platform::window_t &window);
}
